...
class Patron:
    ...
    def get_fine_amount(self):
        return round(self._fine_amount, 3)
    ...
    def amend_fine(self, amount):
        if amount > 0:
            self._fine_amount = round(self._fine_amount + amount, 3)
        else:
            self._fine_amount = round(self._fine_amount - abs(amount), 3)
